...
invasion.exp.data$Treatment<-as.factor(invasion.exp.data$Treatment)

levels(invasion.exp.data$Treatment)[levels(invasion.exp.data$Treatment)=="AIRAbsent"] <- "Ambient CO2, Absent"
levels(invasion.exp.data$Treatment)[levels(invasion.exp.data$Treatment)=="CO2Present"] <- "Elevated CO2, Present"
levels(invasion.exp.data$Treatment)[levels(invasion.exp.data$Treatment)=="AIRPresent"] <- "Ambient CO2, Present"
levels(invasion.exp.data$Treatment)[levels(invasion.exp.data$Treatment)=="CO2Absent"] <- "Elevated CO2, Absent"
...
invasion.exp.data.12<-invasion.exp.data[invasion.exp.data$Week==12, ]
...
cbbPalette.blue4<- c( "#619CFF", "#619CFF", "#619CFF", "#619CFF")

cbbPalette.all.purple<-c( "#666666","#CC99CC", "#666666","#CC99CC")
...
View(cdata.botryllid)

plot.botryllid<-ggplot(cdata.botryllid, aes(x=Week, y=botryllid.mean, shape=Treatment)) + geom_errorbar(aes(ymin=botryllid.mean-botryllid.se, ymax=botryllid.mean+botryllid.se), width=0.25) + geom_line(aes(linetype=CO2.Treatment), size=1) + geom_point(aes(shape=Treatment),size=5, col="#666666") + scale_colour_manual(values=cbbPalette.all.purple)+scale_shape_manual(values=c(1,19,2,17))+scale_linetype_manual(values=c("solid", "dashed"))
plot.botryllid<- plot.botryllid + labs(x = "Time (weeks)", y="% cover Botryllus")+ theme_bw()+ theme(text = element_text(size=16), axis.text = element_text(size=16)) + theme(axis.title.y = element_text(angle=90))+xlim(0,16)
plot.botryllid<-plot.botryllid + theme(legend.text = element_text(colour="black", size = 10))+theme(legend.title = element_text(colour="black", size=12), legend.position=c(.80,.90))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.botryllid.14<- ggplot(invasion.exp.data.14, aes(x=invasion.exp.data.14$min.10.pH, y=(invasion.exp.data.14$botryllid*0.01), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill = "grey60", size=1.5)
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.botryllid.6<- ggplot(invasion.exp.data.6, aes(x=invasion.exp.data.6$min.10.pH, y=(invasion.exp.data.6$botryllid*0.01), colour=Invasives)) +geom_point(size=5) + guides(fill=FALSE) + scale_colour_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", size=1.5, method="lm")
plot.botryllid.6<- plot.botryllid.6 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Species botryllid"))  + theme(text = element_text(size=6), axis.text = element_text(size=6))+theme(axis.title.y = element_text(angle=90))
plot.botryllid.6<- plot.botryllid.6 + theme(legend.text = element_text(colour="black", size = 6))+ theme(legend.title = element_text(colour="black", size=6))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.botryllid.6<- plot.botryllid.6+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.botryllid.6

plot.botryllid.8<- ggplot(invasion.exp.data.8, aes(x=invasion.exp.data.8$min.10.pH, y=(invasion.exp.data.8$botryllid*0.01), colour=Invasives)) + scale_colour_discrete(name = "Invasives")+geom_point(size=5) + guides(fill=FALSE) + scale_colour_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey80", size=1.5, method="lm")
plot.botryllid.8<- plot.botryllid.8 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Species botryllid"))  + theme(text = element_text(size=8), axis.text = element_text(size=8))+theme(axis.title.y = element_text(angle=90))
plot.botryllid.8<- plot.botryllid.8 + theme(legend.text = element_text(colour="black", size = 8))+ theme(legend.title = element_text(colour="black", size=8))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.botryllid.8<- plot.botryllid.8+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.botryllid.8

plot.botryllid.10<- ggplot(invasion.exp.data.10, aes(x=invasion.exp.data.10$min.10.pH, y=(invasion.exp.data.10$botryllid*0.01), colour=Invasives)) + scale_colour_discrete(name = "Invasives")+geom_point(size=5) + guides(fill=FALSE) + scale_colour_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey100", size=1.5, method="lm")
plot.botryllid.10<- plot.botryllid.10 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Species botryllid"))  + theme(text = element_text(size=10), axis.text = element_text(size=10))+theme(axis.title.y = element_text(angle=90))
plot.botryllid.10<- plot.botryllid.10 + theme(legend.text = element_text(colour="black", size = 10))+ theme(legend.title = element_text(colour="black", size=10))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.botryllid.10<- plot.botryllid.10+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.botryllid.10

#last month
plot.botryllid.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$min.10.pH, y=(invasion.exp.data.lastmonth$botryllid*0.01), colour=Invasives)) + scale_colour_discrete(name = "Invasives")+geom_point(size=5) + guides(fill=FALSE) + scale_colour_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", size=1.5, method="lm")
plot.botryllid.lastmonth<- plot.botryllid.lastmonth + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Species botryllid"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.botryllid.lastmonth<- plot.botryllid.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.botryllid.lastmonth<- plot.botryllid.lastmonth+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.botryllid.lastmonth
...
head(invasion.exp.data.8to16)
plot.botryllid.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$botryllid*0.01), colour=Invasives)) + scale_colour_discrete(name = "Invasives")+geom_point(size=5) + guides(fill=FALSE) + scale_colour_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", size=1.5, method="lm")
plot.botryllid.8to16<- plot.botryllid.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Species botryllid"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.botryllid.8to16<- plot.botryllid.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.botryllid.8to16<- plot.botryllid.8to16+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.botryllid.8to16

plot.botryllid.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$botryllid), shape=Invasives))  + geom_point(aes(shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + geom_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, method = 'lm', size=1.5)+ scale_fill_manual(values=cbbPalette.blue2)+ scale_colour_discrete(name = "Invasives")+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.botryllid.8to16<- plot.botryllid.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("% cover Botryllus"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.botryllid.8to16<- plot.botryllid.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.botryllid.8to16<- plot.botryllid.8to16+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.botryllid.8to16

#binomial
plot.botryllid.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$botryllid*0.01), shape=Invasives))  + geom_point(aes(shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + binomial_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, size=1.5)+ scale_fill_manual(values=cbbPalette.blue2)+ scale_colour_discrete(name = "Invasives")+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.botryllid.8to16<- plot.botryllid.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("% cover Botryllus"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.botryllid.8to16<- plot.botryllid.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.botryllid.8to16<- plot.botryllid.8to16+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.botryllid.8to16
...
plot.botryllid.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$botryllid*0.01)))  + geom_point(aes(shape=Treatment),size=5, col="#666666") + guides(fill=FALSE) + binomial_smooth(aes(fill=Invasives, lty=Invasives), colour="#666666", alpha=0.15, size=1.5)+ scale_fill_manual(values=c( "#FFFFFF","#666666"))+ scale_colour_discrete(name = "Invasives")+scale_shape_manual(values=c(1,19, 2, 17))+scale_linetype_manual(values=c("dashed", "solid"))
plot.botryllid.8to16<- plot.botryllid.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Proportion cover Botryllus"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.botryllid.8to16<- plot.botryllid.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.botryllid.8to16<- plot.botryllid.8to16+ theme(legend.position="none")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.botryllid.8to16 
...
plot_grid(plot.botryllid, plot.botryllid.8to16 , ncol=2, align='h', labels=c('(a)', '(b)', label_size=12))
...
invasion.exp.data$native.space<-(invasion.exp.data$occupied.space)-(invasion.exp.data$botryllid)
...
plot.occupied.space<-plot.occupied.space + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
cdata.native.space <- summaryBy(native.space ~ Treatment + Invasives + CO2.Treatment + Week, data=invasion.exp.data, FUN=function(x) { c(mean = mean(x), sd = sd(x), length=length(x)) } )
names(cdata.native.space)[names(cdata.native.space)=="native.space.length"]<-"N"
cdata.native.space$native.space.se<-cdata.native.space$native.space.sd/sqrt(cdata.native.space$N)
head(cdata.native.space)

plot.native.space<-ggplot(cdata.native.space, aes(x=Week, y=native.space.mean, color = Invasives, shape=CO2.Treatment, linetype=CO2.Treatment)) + geom_errorbar(aes(ymin=native.space.mean-native.space.se, ymax=native.space.mean+native.space.se), width=0.25) + geom_line(size=1) + geom_point(size=5) + scale_colour_manual(values=cbbPalette.all.purple)
plot.native.space<- plot.native.space + labs(x = "Time (weeks)", y="Native space")+ theme_bw()+ theme(text = element_text(size=16), axis.text = element_text(size=16)) + theme(axis.title.y = element_text(angle=90))
plot.native.space<-plot.native.space + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
plot.native.space <- plot.native.space + theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.native.space 

binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.occupied.space.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.16$occupied.space*0.01), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill = "grey60", size=1.5)
...
plot.occupied.space.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.16$occupied.space*0.01), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", size=1.5, method="lm")
plot.occupied.space.16<- plot.occupied.space.16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Species occupied.space"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.occupied.space.16<- plot.occupied.space.16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.occupied.space.16<- plot.occupied.space.16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.occupied.space.16

plot.occupied.space.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$occupied.space), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", size=1.5, method="lm")
plot.occupied.space.8to16<- plot.occupied.space.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("occupied.space"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.occupied.space.8to16<- plot.occupied.space.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.occupied.space.8to16<- plot.occupied.space.8to16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.occupied.space.8to16


plot.native.space.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$native.space), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", size=1.5, method="lm")
plot.native.space.8to16<- plot.native.space.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("native.space"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.native.space.8to16<- plot.native.space.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.native.space.8to16<- plot.native.space.8to16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.native.space.8to16

plot.native.space.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$botryllid, y=(invasion.exp.data.lastmonth$native.space*0.01), colour=CO2.Treatment)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", size=1.5, method="lm")
plot.native.space.lastmonth<- plot.native.space.lastmonth + theme_bw() + xlab(bquote('tunicate presence')) + ylab(expression("native.space"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.native.space.lastmonth<- plot.native.space.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.native.space.lastmonth<- plot.native.space.lastmonth+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.native.space.lastmonth

plot.native.space.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.8to16$botryllid, y=(invasion.exp.data.8to16$native.space*0.01), colour=CO2.Treatment)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", size=1.5, method="lm")
plot.native.space.8to16<- plot.native.space.8to16 + theme_bw() + xlab(bquote('tunicate presence')) + ylab(expression("native.space"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.native.space.8to16<- plot.native.space.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.native.space.8to16<- plot.native.space.8to16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.native.space.8to16
...
plot.native.space.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$native.space), shape=Invasives))  + geom_point(aes(shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + geom_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, method = 'glm', method.args = list(family = "poisson"), size=1.5)+ scale_fill_manual(values=cbbPalette.blue2)+ scale_colour_discrete(name = "Invasives")+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.native.space.8to16<- plot.native.space.8to16 + theme_bw() + xlab(bquote('Botryllus')) + ylab(expression("Native space occupation"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.native.space.8to16<- plot.native.space.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.native.space.8to16<- plot.native.space.8to16+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.native.space.8to16

plot.native.space.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.8to16$botryllid, y=(invasion.exp.data.8to16$native.space*0.01), shape=CO2.Treatment))  + geom_point(aes(shape=CO2.Treatment),size=5, col="#619CFF") + guides(fill=FALSE) + binomial_smooth(aes(fill=CO2.Treatment, lty=CO2.Treatment), colour="#619CFF", alpha=0.15, size=1.5)+ scale_fill_manual(values=cbbPalette.blue2)+ scale_colour_discrete(name = "CO2")+scale_shape_manual(values=c(19,17))+scale_linetype_manual(values=c("solid", "dashed"))
plot.native.space.8to16<- plot.native.space.8to16 + theme_bw() + xlab(bquote('% cover Botryllus')) + ylab(expression("Native space occupation"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.native.space.8to16<- plot.native.space.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.native.space.8to16<- plot.native.space.8to16+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.native.space.8to16


plot.native.space.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$botryllid, y=(invasion.exp.data.16$native.space), shape=CO2.Treatment))  + geom_point(aes(shape=CO2.Treatment),size=5, col="#619CFF") + guides(fill=FALSE) + geom_smooth(method="lm",aes(fill=CO2.Treatment, lty=CO2.Treatment), colour="#619CFF", alpha=0.15, size=1.5)+ scale_fill_manual(values=cbbPalette.blue2)+ scale_colour_discrete(name = "CO2")+scale_shape_manual(values=c(19,17))+scale_linetype_manual(values=c("solid", "dashed"))
plot.native.space.16<- plot.native.space.16 + theme_bw() + xlab(bquote('% cover Botryllus')) + ylab(expression("Native space occupation"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.native.space.16<- plot.native.space.16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.native.space.16<- plot.native.space.16+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.native.space.16



#### by pH last month 

plot.native.space.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$min.10.pH, y=(invasion.exp.data.lastmonth$native.space), shape=Invasives))  + geom_point(aes(shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + geom_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, method = 'lm', size=1.5)+ scale_fill_manual(values=cbbPalette.blue2)+ scale_colour_discrete(name = "CO2")+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.native.space.lastmonth<- plot.native.space.lastmonth + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Native space occupation"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.native.space.lastmonth<- plot.native.space.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.native.space.lastmonth<- plot.native.space.lastmonth+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.native.space.lastmonth

#### 
plot.native.space.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$botryllid, y=(invasion.exp.data.lastmonth$native.space), shape=CO2.Treatment))  + geom_point(aes(shape=CO2.Treatment),size=5, col="#619CFF") + guides(fill=FALSE) + geom_smooth(aes(fill=CO2.Treatment, lty=CO2.Treatment), colour="#619CFF", alpha=0.15, method = 'lm', size=1.5)+ scale_fill_manual(values=cbbPalette.blue2)+ scale_colour_discrete(name = "CO2")+scale_shape_manual(values=c(19,17))+scale_linetype_manual(values=c("dashed", "solid"))
plot.native.space.lastmonth<- plot.native.space.lastmonth + theme_bw() + xlab(bquote('% cover Botryllus')) + ylab(expression("% cover native species"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.native.space.lastmonth<- plot.native.space.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.native.space.lastmonth<- plot.native.space.lastmonth+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.native.space.lastmonth

###binomial model
plot.native.space.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$botryllid, y=(invasion.exp.data.lastmonth$native.space*0.01), shape=CO2.Treatment))  + geom_point(aes(shape=CO2.Treatment),size=5, col="#619CFF") + guides(fill=FALSE) + binomial_smooth(aes(fill=CO2.Treatment, lty=CO2.Treatment), colour="#619CFF", alpha=0.15, size=1.5)+ scale_fill_manual(values=cbbPalette.blue2)+ scale_colour_discrete(name = "CO2")+scale_shape_manual(values=c(19,17))+scale_linetype_manual(values=c("dashed", "solid"))
plot.native.space.lastmonth<- plot.native.space.lastmonth + theme_bw() + xlab(bquote('Botryllus')) + ylab(expression("Native space occupation"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.native.space.lastmonth<- plot.native.space.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.native.space.lastmonth<- plot.native.space.lastmonth+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.native.space.lastmonth
...
plot.tile.brick.biomass.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.16$tile.brick.biomass), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", method = 'lm', size=1.5)
...
plot.num.species.no.bot<-ggplot(cdata.num.species.no.bot, aes(x=Week, y=num.species.no.bot.mean, color=Treatment, shape=Treatment, linetype=CO2.Treatment)) + geom_errorbar(aes(ymin=num.species.no.bot.mean-num.species.no.bot.se, ymax=num.species.no.bot.mean+num.species.no.bot.se), width=0.25) + geom_line(size=1) + geom_point(size=5) + scale_colour_manual(values=cbbPalette.blue4)+scale_shape_manual(values=c(1, 19, 2, 17))
plot.num.species.no.bot<- plot.num.species.no.bot + labs(x = "Time (weeks)", y="Native species richness")+ theme_bw()+ theme(text = element_text(size=16), axis.text = element_text(size=16)) + theme(axis.title.y = element_text(angle=90))
plot.num.species.no.bot<-plot.num.species.no.bot + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
plot.num.species.no.bot <- plot.num.species.no.bot+theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.species.no.bot 
+  theme(legend.position="none")

plot.num.species.no.bot.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.16$num.species.no.bot), colour=Invasives))  + geom_point(size=5) + guides(fill=FALSE) + geom_smooth(fill = "grey60", method = 'glm', method.args = list(family = "poisson"), size=1.5)+ scale_fill_manual(values=cbbPalette.all.purple)+ scale_colour_discrete(name = "Invasives")
...
plot.num.species.no.bot.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$min.10.pH, y=(invasion.exp.data.lastmonth$num.species.no.bot), colour=Invasives))  + geom_point(size=5) + guides(fill=FALSE) + geom_smooth(fill = "grey60", method = 'glm', method.args = list(family = "poisson"), size=1.5)+ scale_fill_manual(values=cbbPalette.all.purple)+ scale_colour_discrete(name = "Invasives")
plot.num.species.no.bot.lastmonth<- plot.num.species.no.bot.lastmonth + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Species num.species.no.bot"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.species.no.bot.lastmonth<- plot.num.species.no.bot.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.species.no.bot.lastmonth<- plot.num.species.no.bot.lastmonth+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.species.no.bot.lastmonth




plot.num.species.no.bot.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$botryllid, y=(invasion.exp.data.16$num.species.no.bot), colour=CO2.Treatment))  + geom_point(size=5) + guides(fill=FALSE) + geom_smooth(fill = "grey60", method = 'glm', method.args = list(family = "poisson"), size=1.5)+ scale_fill_manual(values=cbbPalette.all.purple)+ scale_colour_discrete(name = "CO2 Treatment")
plot.num.species.no.bot.16<- plot.num.species.no.bot.16 + theme_bw() + xlab(bquote('Botryllus')) + ylab(expression("Species num.species.no.bot"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.species.no.bot.16<- plot.num.species.no.bot.16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.species.no.bot.16<- plot.num.species.no.bot.16+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.species.no.bot.16


plot.num.species.no.bot.12<- ggplot(invasion.exp.data.12, aes(x=invasion.exp.data.12$botryllid, y=(invasion.exp.data.12$num.species.no.bot), colour=CO2.Treatment))  + geom_point(size=5) + guides(fill=FALSE) + geom_smooth(fill = "grey60", method = 'glm', method.args = list(family = "poisson"), size=1.5)+ scale_fill_manual(values=cbbPalette.all.purple)+ scale_colour_discrete(name = "CO2 Treatment")
plot.num.species.no.bot.12<- plot.num.species.no.bot.12 + theme_bw() + xlab(bquote('Botryllus')) + ylab(expression("Species num.species.no.bot"))  + theme(text = element_text(size=12), axis.text = element_text(size=12))+theme(axis.title.y = element_text(angle=90))
...
plot.num.species.no.bot.lastmonth.bypH<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$min.10.pH, y=(invasion.exp.data.lastmonth$num.species.no.bot), colour=Invasives))  + geom_point(size=5) + guides(fill=FALSE) + geom_smooth(fill = "grey60", method = 'glm', method.args = list(family = "poisson"), size=1.5)+ scale_fill_manual(values=cbbPalette.all.purple)+ scale_colour_discrete(name = "CO2 Treatment")
plot.num.species.no.bot.lastmonth.bypH<- plot.num.species.no.bot.lastmonth.bypH + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Species num.species.no.bot"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.species.no.bot.lastmonth.bypH<- plot.num.species.no.bot.lastmonth.bypH + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.species.no.bot.lastmonth.bypH<- plot.num.species.no.bot.lastmonth.bypH+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.species.no.bot.lastmonth.bypH

plot.num.species.no.bot.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$botryllid, y=(invasion.exp.data.lastmonth$num.species.no.bot), colour=CO2.Treatment))  + geom_point(size=5) + guides(fill=FALSE) + geom_smooth(fill = "grey60", method = 'glm', method.args = list(family = "poisson"), size=1.5)+ scale_fill_manual(values=cbbPalette.all.purple)+ scale_colour_discrete(name = "CO2 Treatment")
plot.num.species.no.bot.lastmonth<- plot.num.species.no.bot.lastmonth + theme_bw() + xlab(bquote('Botryllus')) + ylab(expression("Species num.species.no.bot"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.species.no.bot.lastmonth<- plot.num.species.no.bot.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.species.no.bot.lastmonth<- plot.num.species.no.bot.lastmonth+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.species.no.bot.lastmonth

###### Species richness by botryllid
plot.num.species.no.bot.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.8to16$botryllid, y=(invasion.exp.data.8to16$num.species.no.bot)))  + geom_point(aes(shape=Treatment),size=5, col="#619CFF") + guides(fill=FALSE) + geom_smooth(aes(fill=CO2.Treatment, lty=CO2.Treatment), colour="#619CFF", alpha=0.15, method = 'glm', method.args = list(family = "poisson"), size=1.5)+ scale_fill_manual(values=cbbPalette.blue2)+ scale_colour_discrete(name = "CO2")+scale_shape_manual(values=c(1,19,2,17))+scale_linetype_manual(values=c("dashed", "solid"))
plot.num.species.no.bot.8to16<- plot.num.species.no.bot.8to16 + theme_bw() + xlab(bquote('% cover Botryllus')) + ylab(expression("Native species richness"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.species.no.bot.8to16<- plot.num.species.no.bot.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.species.no.bot.8to16<- plot.num.species.no.bot.8to16+  theme(legend.position="none")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.species.no.bot.8to16
...
###
plot.num.species.no.bot.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$num.species.no.bot), shape=Invasives))  + geom_point(aes(shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + geom_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, method = 'glm', method.args = list(family = "poisson"), size=1.5)+ scale_fill_manual(values=cbbPalette.blue2)+ scale_colour_discrete(name = "Invasives")+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.num.species.no.bot.8to16<- plot.num.species.no.bot.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Native species richness"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.species.no.bot.8to16<- plot.num.species.no.bot.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.species.no.bot.8to16<- plot.num.species.no.bot.8to16+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.species.no.bot.8to16


lmer.bottohyd.weeks.3<- lmer(bottohyd~ CO2*Food.quality*Week + (1|Mesocosm) + (0+Week|Mesocosm), data = food.exp.data.not0)

##### native species by botryllus ... and CO2 ... 8to16
glm.num.species<-glm(formula = (num.species.no.bot) ~ CO2.Treatment*botryllid , data = invasion.exp.data.8to16, family = "poisson")
summary(glm.num.species)
plot(glm.num.species)
Anova(glm.num.species, type=3)
### can't get the lastmonth with WEek and mesocosm as random factors to work ... 
#### glmmadmb or #glmer? ... oops .. 



nbinom12 <- fitdistr(invasion.exp.data.lastmonth$num.species.no.bot, "Negative Binomial")
qqp(invasion.exp.data.lastmonth$num.species.no.bot, "nbinom", size = nbinom12$estimate[[1]], mu = nbinom12$estimate[[2]])


poisson.16<-fitdistr(invasion.exp.data.lastmonth$num.species.no.bot, "Poisson")
qqp(invasion.exp.data.lastmonth$num.species.no.bot, "pois", poisson.16$estimate)

qqp(invasion.exp.data.lastmonth$num.species.no.bot, "norm")


invasion.exp.data.lastmonth$Invasives<-as.factor(invasion.exp.data.lastmonth$Invasives)
invasion.exp.data.lastmonth$Week<-as.factor(invasion.exp.data.lastmonth$Week)
invasion.exp.data.lastmonth$Mesocosm<-as.factor(invasion.exp.data.lastmonth$Mesocosm)
invasion.exp.data.lastmonth$CO2.Treatment<-as.factor(invasion.exp.data.lastmonth$CO2.Treatment)
invasion.exp.data.lastmonth$Tile.ID<-as.character(invasion.exp.data.lastmonth$Tile.ID)



#### model can't figure out ... why is invasives NS ... very obviously separated??? Only when I include CO2 as predictor? 
glm.poisson.num.num.species.no.bot.16<-glmmadmb(formula = (num.species.no.bot) ~ min.10.pH*Invasives + (1|Tile.ID), data = invasion.exp.data.lastmonth, family = "poisson")
summary(glm.poisson.num.num.species.no.bot.16)
plot(glm.poisson.num.num.species.no.bot.16)
Anova(glm.poisson.num.num.species.no.bot.16, type=3)

lmer.poisson.num.num.species.no.bot.16<-glmer(formula = (num.species.no.bot) ~ min.10.pH*Invasives+ (1|Tile.ID), data = invasion.exp.data.lastmonth, family="poisson")
summary(lmer.poisson.num.num.species.no.bot.16)
plot(lmer.poisson.num.num.species.no.bot.16)
Anova(lmer.poisson.num.num.species.no.bot.16, type=3)


head(invasion.exp.data.lastmonth)
invasion.exp.data.lastmonth$Tile.ID<-as.factor(invasion.exp.data.lastmonth$Tile.ID)
invasion.exp.data.lastmonth$Invasives<-invasion.exp.data.lastmonth$Invasives
invasion.exp.data.lastmonth$Week<-invasion.exp.data.lastmonth$Week

glm.poisson.num.serpulid.no.bot.16<-glmmadmb(formula = (num.serpulid) ~ min.10.pH*Invasives + (1|Tile.ID), data = invasion.exp.data.lastmonth, family = "poisson")
summary(glm.poisson.num.serpulid.no.bot.16)
plot(glm.poisson.num.serpulid.no.bot.16)
Anova(glm.poisson.num.serpulid.no.bot.16, type=3)



####### can't figure this out .... what's the best formula? 
ddf = "Kenward-Roger")
#### Is this significant effect of CO2??? 
...
plot.shannon.diversity<-plot.shannon.diversity + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
plot.shannon.diversity.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.16$shannon.diversity), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", method = 'lm', size=1.5)
plot.shannon.diversity.16<- plot.shannon.diversity.16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Shannon diversity"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.shannon.diversity.16<- plot.shannon.diversity.16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.shannon.diversity.16<- plot.shannon.diversity.16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.shannon.diversity.16
...
plot.shannon.diversity.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$min.10.pH, y=(invasion.exp.data.lastmonth$shannon.diversity+0.001), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", method = 'glm', method.args = list(family = "Gamma"), size=1.5)
plot.shannon.diversity.lastmonth<- plot.shannon.diversity.lastmonth + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Shannon diversity"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.shannon.diversity.lastmonth<- plot.shannon.diversity.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.shannon.diversity.lastmonth<- plot.shannon.diversity.lastmonth+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.shannon.diversity.lastmonth

plot.shannon.diversity.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$botryllid, y=(invasion.exp.data.lastmonth$shannon.diversity+0.001), colour=CO2.Treatment)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", method = 'glm',  method.args = list(family = "Gamma"), size=1.5)
plot.shannon.diversity.lastmonth<- plot.shannon.diversity.lastmonth + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Shannon diversity"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.shannon.diversity.lastmonth<- plot.shannon.diversity.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.shannon.diversity.lastmonth<- plot.shannon.diversity.lastmonth+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.shannon.diversity.lastmonth

plot.shannon.diversity.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$shannon.diversity), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", method="glm",  method.args = list(family = "Gamma"), size=1.5)
plot.shannon.diversity.8to16<- plot.shannon.diversity.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Shannon diversity"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.shannon.diversity.8to16<- plot.shannon.diversity.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.shannon.diversity.8to16<- plot.shannon.diversity.8to16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.shannon.diversity.8to16

plot.shannon.diversity.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.8to16$botryllid, y=(invasion.exp.data.8to16$shannon.diversity), colour=CO2.Treatment)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", method = 'lm', size=1.5)
plot.shannon.diversity.8to16<- plot.shannon.diversity.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Shannon diversity"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.shannon.diversity.8to16<- plot.shannon.diversity.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.shannon.diversity.8to16<- plot.shannon.diversity.8to16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.shannon.diversity.8to16
...
##### hydroid
cdata.hydroid <- summaryBy(hydroid ~ Treatment + Invasives + CO2.Treatment + Week, data=invasion.exp.data, FUN=function(x) { c(mean = mean(x), sd = sd(x), length=length(x)) } )
names(cdata.hydroid)[names(cdata.hydroid)=="hydroid.length"]<-"N"
cdata.hydroid$hydroid.se<-cdata.hydroid$hydroid.sd/sqrt(cdata.hydroid$N)
head(cdata.hydroid)

plot.hydroid<-ggplot(cdata.hydroid, aes(x=Week, y=hydroid.mean, color = Invasives, shape=CO2.Treatment, linetype=CO2.Treatment)) + geom_errorbar(aes(ymin=hydroid.mean-hydroid.se, ymax=hydroid.mean+hydroid.se), width=0.25) + geom_line(size=1) + geom_point(size=5) + scale_colour_manual(values=cbbPalette.all.purple)
plot.hydroid<- plot.hydroid + labs(x = "Time (weeks)", y="Species hydroid")+ theme_bw()+ theme(text = element_text(size=16), axis.text = element_text(size=16)) + theme(axis.title.y = element_text(angle=90))
plot.hydroid<-plot.hydroid + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
plot.hydroid <- plot.hydroid + theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.hydroid 

binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.hydroid.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.16$hydroid*0.01), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill = "grey60", size=1.5)
plot.hydroid.16<- plot.hydroid.16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Species hydroid"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.hydroid.16<- plot.hydroid.16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.hydroid.16<- plot.hydroid.16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.hydroid.16

plot.hydroid.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$botryllid, y=(invasion.exp.data.lastmonth$hydroid*0.01), colour=CO2.Treatment)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", size=1.5)
plot.hydroid.lastmonth<- plot.hydroid.lastmonth + theme_bw() + xlab(bquote('% botryllus')) + ylab(expression("Species hydroid"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.hydroid.lastmonth<- plot.hydroid.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.hydroid.lastmonth<- plot.hydroid.lastmonth+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.hydroid.lastmonth


##### num.serpulid
head(invasion.exp.data)
cdata.num.serpulid <- summaryBy(num.serpulid ~ Treatment + Invasives + CO2.Treatment + Week, data=invasion.exp.data, FUN=function(x) { c(mean = mean(x), sd = sd(x), length=length(x)) } )
names(cdata.num.serpulid)[names(cdata.num.serpulid)=="num.serpulid.length"]<-"N"
cdata.num.serpulid$num.serpulid.se<-cdata.num.serpulid$num.serpulid.sd/sqrt(cdata.num.serpulid$N)
head(cdata.num.serpulid)

plot.num.serpulid<-ggplot(cdata.num.serpulid, aes(x=Week, y=num.serpulid.mean, color = Invasives, shape=CO2.Treatment, linetype=CO2.Treatment)) + geom_errorbar(aes(ymin=num.serpulid.mean-num.serpulid.se, ymax=num.serpulid.mean+num.serpulid.se), width=0.25) + geom_line(size=1) + geom_point(size=5) + scale_colour_manual(values=cbbPalette.all.purple)
plot.num.serpulid<- plot.num.serpulid + labs(x = "Time (weeks)", y="Species num.serpulid")+ theme_bw()+ theme(text = element_text(size=16), axis.text = element_text(size=16)) + theme(axis.title.y = element_text(angle=90))
plot.num.serpulid<-plot.num.serpulid + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
plot.num.serpulid <- plot.num.serpulid + theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.serpulid 

plot.num.serpulid.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.16$num.serpulid), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", size=1.5, method="lm")
plot.num.serpulid.16<- plot.num.serpulid.16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Species num.serpulid"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.serpulid.16<- plot.num.serpulid.16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.serpulid.16<- plot.num.serpulid.16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.serpulid.16

plot.num.serpulid.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$botryllid, y=(invasion.exp.data.lastmonth$num.serpulid), colour=CO2.Treatment)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", size=1.5, method = 'glm', method.args = list(family = "poisson"))
plot.num.serpulid.lastmonth<- plot.num.serpulid.lastmonth + theme_bw() + xlab(bquote('% botryllus')) + ylab(expression("Species num.serpulid"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.serpulid.lastmonth<- plot.num.serpulid.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.serpulid.lastmonth<- plot.num.serpulid.lastmonth+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.serpulid.lastmonth

plot.num.serpulid.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$min.10.pH, y=(invasion.exp.data.lastmonth$num.serpulid), col=Invasives)) + geom_point(aes(col=Invasives, shape=Invasives),size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all)+ geom_smooth(aes(col=Invasives, fill=Invasives),alpha=0.15, size=1.5, method = 'glm', method.args = list(family = "poisson"))+scale_shape_manual(values=c(2,19))
plot.num.serpulid.lastmonth<- plot.num.serpulid.lastmonth + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Species num.serpulid"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.serpulid.lastmonth<- plot.num.serpulid.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.serpulid.lastmonth<- plot.num.serpulid.lastmonth+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.serpulid.lastmonth


plot.num.serpulid.lastmonth<- ggplot(invasion.exp.data.lastmonth, aes(x=invasion.exp.data.lastmonth$min.10.pH, y=(invasion.exp.data.lastmonth$num.serpulid))) + geom_point(aes( shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.blue2)+ geom_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, size=1.5, method = 'glm', method.args = list(family = "poisson"))+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.num.serpulid.lastmonth<- plot.num.serpulid.lastmonth + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Number of serpulids per tile"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.serpulid.lastmonth<- plot.num.serpulid.lastmonth + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.serpulid.lastmonth<- plot.num.serpulid.lastmonth+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.serpulid.lastmonth
...
plot.num.serpulid.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$num.serpulid))) + geom_point(aes( shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.blue2)+ geom_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, size=1.5, method = 'glm', method.args = list(family = "poisson"))+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.num.serpulid.8to16<- plot.num.serpulid.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Number of serpulids per tile"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.serpulid.8to16<- plot.num.serpulid.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.serpulid.8to16<- plot.num.serpulid.8to16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.serpulid.8to16


plot.membranipora.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$membranipora))) + geom_point(aes( shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.blue2)+ geom_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, size=1.5, method = 'glm', method.args = list(family = "poisson"))+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.membranipora.8to16<- plot.membranipora.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("% membranipora per tile"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.membranipora.8to16<- plot.membranipora.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.membranipora.8to16<- plot.membranipora.8to16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.membranipora.8to16

plot.num.barn.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$num.barn))) + geom_point(aes( shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.blue2)+ geom_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, size=1.5, method = 'glm', method.args = list(family = "poisson"))+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.num.barn.8to16<- plot.num.barn.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Number of barnacles per tile"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.barn.8to16<- plot.num.barn.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.barn.8to16<- plot.num.barn.8to16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.barn.8to16

plot.num.corella.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$num.corella))) + geom_point(aes( shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.blue2)+ geom_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, size=1.5, method = 'glm', method.args = list(family = "poisson"))+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.num.corella.8to16<- plot.num.corella.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Number of corella per tile"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.corella.8to16<- plot.num.corella.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.corella.8to16<- plot.num.corella.8to16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.corella.8to16

plot.num.red.bryo.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$num.red.bryo))) + geom_point(aes( shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.blue2)+ geom_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, size=1.5, method = 'glm', method.args = list(family = "poisson"))+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.num.red.bryo.8to16<- plot.num.red.bryo.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Number of serpulids per tile"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.num.red.bryo.8to16<- plot.num.red.bryo.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.num.red.bryo.8to16<- plot.num.red.bryo.8to16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.num.red.bryo.8to16


plot.mussel.8to16<- ggplot(invasion.exp.data.8to16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.8to16$mussel))) + geom_point(aes( shape=Invasives),size=5, col="#619CFF") + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.blue2)+ geom_smooth(aes(fill=Invasives, lty=Invasives), colour="#619CFF", alpha=0.15, size=1.5, method = 'glm', method.args = list(family = "poisson"))+scale_shape_manual(values=c(1,19))+scale_linetype_manual(values=c("dashed", "solid"))
plot.mussel.8to16<- plot.mussel.8to16 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Mussel per tile"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.mussel.8to16<- plot.mussel.8to16 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.mussel.8to16<- plot.mussel.8to16+ scale_colour_discrete(name = "Invasives")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.mussel.8to16


head(invasion.exp.data.8to16)

cbbPalette.all<- c( "#F6766D", "#00BA36", "#619CFF", "#F6766D", "#00BA36", "#619CFF")
cbbPalette.blue2<- c("#619CFF","#619CFF")
cbbPalette.blue2<- c("#619CFF","#619CFF")


plot.shannon.diversity.12<- ggplot(food.exp.data.12, aes(x=food.exp.data.12$min.10.pH, y=(food.exp.data.12$shannon.diversity), colour=Food.quality)) + geom_point(size=5,aes(colour=factor(Food.quality))) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all)+ geom_smooth(aes(col=Food.quality, fill=Food.quality), alpha=0.15,size=1.5, method="lm")
plot.shannon.diversity.12<- plot.shannon.diversity.12 + theme_bw() + xlab(bquote('min.10.pH')) + ylab(expression("Shannon diversity"))  + theme(text = element_text(size=16), axis.text = element_text(size=16))+theme(axis.title.y = element_text(angle=90))
plot.shannon.diversity.12<- plot.shannon.diversity.12 + theme(legend.text = element_text(colour="black", size = 16))+ theme(legend.title = element_text(colour="black", size=16))+theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.y = element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )
plot.shannon.diversity.12<- plot.shannon.diversity.12+ scale_colour_discrete(name = "Food.quality")+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))+ theme(axis.text.x = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")), axis.text.y = element_text(margin=margin(0.5, 0.5, 0.5, 0.5, "cm")))
plot.shannon.diversity.12

head(invasion.exp.data.last.month)

##### Each meso needs to not be own data point ... why not though? 
###poisson.... 
...
plot.num.didemnum<-plot.num.didemnum + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
plot.num.didemnum.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.16$num.didemnum), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", method = 'glm', method.args = list(family = "poisson"), size=1.5)
...
plot.num.nudi.eggs.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.16$num.nudi.eggs), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill = "grey60", method = 'glm', method.args = list(family = "poisson"), size=1.5)
...
plot.num.nudi.eggs<-plot.num.nudi.eggs + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
plot.disporella<-plot.disporella + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.disporella.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=(invasion.exp.data.16$disporella*0.01), colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
plot.disporella.flat<-plot.disporella.flat + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.disporella.flat.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$disporella.flat, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
plot.disporella.erect.all<-plot.disporella.erect.all + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.disporella.erect.all.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$disporella.erect.all, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
plot.disporella.erect.knobs<-plot.disporella.erect.knobs + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.disporella.erect.knobs.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$disporella.erect.knobs, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
plot.disporella.erect.fan<-plot.disporella.erect.fan + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.disporella.erect.fan.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$disporella.erect.fan, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.disporella.erect.ruffles.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$disporella.erect.ruffles, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
plot.num.disporella<-plot.num.disporella + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
plot.num.disporella.flat<-plot.num.disporella.flat + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
plot.num.disporella.erect.all<-plot.num.disporella.erect.all + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
plot.num.disporella.erect.knobs<-plot.num.disporella.erect.knobs + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
plot.num.disporella.erect.fan<-plot.num.disporella.erect.fan + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
plot.num.prop.disporella.erect.fan<-plot.num.prop.disporella.erect.fan + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.num.prop.disporella.erect.fan.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$num.prop.disporella.erect.fan, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
plot.num.prop.disporella.erect<-plot.num.prop.disporella.erect + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.num.prop.disporella.erect.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$num.prop.disporella.erect, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
plot.num.prop.disporella.erect.knobs<-plot.num.prop.disporella.erect.knobs + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.num.prop.disporella.erect.knobs.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$num.prop.disporella.erect.knobs, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.num.prop.disporella.erect.ruffles.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$num.prop.disporella.erect.ruffles, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
plot.num.prop.disporella.flat<-plot.num.prop.disporella.flat + theme(legend.text = element_text(colour="black", size = 16))+theme(legend.title = element_text(colour="black", size=16), legend.position=c(.15,.60))+theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank(), axis.line=element_line(size=0.25), axis.ticks.length=unit(-0.25, "cm") )+ theme(legend.key = element_blank())+theme(legend.key.size = unit(0.3, "cm"))
...
binomial_smooth <- function(...) {geom_smooth(method = "glm", method.args = list(family = "binomial"), ...)}
plot.num.prop.disporella.flat.16<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$num.prop.disporella.flat, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
####binomial week 6
plot.num.prop.disporella.erect<- ggplot(invasion.exp.data.6, aes(x=invasion.exp.data.6$min.10.pH, y=invasion.exp.data.6$num.prop.disporella.erect, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ binomial_smooth(fill="grey60", size=1.5)
...
plot.num.prop.disporella.erect<- ggplot(invasion.exp.data.6, aes(x=invasion.exp.data.6$min.10.pH, y=invasion.exp.data.6$num.prop.disporella.erect, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple) + geom_smooth(fill = "grey60", method = 'glm', family = 'poisson', size=1.5)
...
### week 6
### Take out an outlier:
invasion.exp.data.6.no.outlier<-invasion.exp.data.6[invasion.exp.data.6$num.prop.disporella.erect<20, ]

head(invasion.exp.data.6.no.outlier)

plot.num.prop.disporella.erect.no.outlier<- ggplot(invasion.exp.data.6.no.outlier, aes(x=invasion.exp.data.6.no.outlier$min.10.pH, y=invasion.exp.data.6.no.outlier$num.prop.disporella.erect, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple) + geom_smooth(fill = "grey60", method = 'glm', family = 'poisson', size=1.5)
...
###for normal
plot.num.prop.disporella.erect<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$num.prop.disporella.erect, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill="grey60", size=1.5, method='lm')
...
### can do glm gamma
plot.num.prop.disporella.erect<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$num.prop.disporella.erect, colour=Invasives)) + geom_point(size=5) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette.all.purple)+ geom_smooth(fill="grey60", size=1.5, method='glm', family='Gamma')
...
plot.num.prop.disporella.erect<- ggplot(invasion.exp.data.16, aes(x=invasion.exp.data.16$min.10.pH, y=invasion.exp.data.16$num.prop.disporella.erect, colour=factor(invasion.exp.data.16$Invasives, levels = c("High", "Low", "high")))) + geom_point(size=4, alpha = 6.5/6) + guides(fill=FALSE) + scale_fill_manual(values=cbbPalette6)+ geom_smooth(method = 'glm', family = 'Gamma')
...
invasion.exp.data.6$Invasives <- factor(invasion.exp.data.6$Invasives, levels = c("None", "Low", "High"))
...
#### week 6 binomial
invasion.exp.data.6$num.prop.disporella.erect<-(invasion.exp.data.6$num.prop.disporella.erect)+0.0001
glm.binomial.num.prop.disporella.erect.6<- glm(formula = cbind(num.prop.disporella.erect, 1.0001-num.prop.disporella.erect)~ min.10.pH*Invasives, data = invasion.exp.data.6, family = "binomial")
plot(glm.binomial.num.prop.disporella.erect.6)
summary(glm.binomial.num.prop.disporella.erect.6)
anova(glm.binomial.num.prop.disporella.erect.6, test = "Chi")
...
library(visreg)
visreg(glm.binomial.num.prop.disporella.erect.6, xvar = "min.10.pH", by= "Invasives", whitespace = 0.4, 
...
##### Week 6
glm.poisson.num.prop.disporella.erect.6<-glm(formula = (num.prop.disporella.erect) ~ min.10.pH*Invasives, data = invasion.exp.data.6, family = "poisson")
summary(glm.poisson.num.prop.disporella.erect.6)
plot(glm.poisson.num.prop.disporella.erect.6)
anova(glm.poisson.num.prop.disporella.erect.6, test = "Chi")
