...
#MUSSEL RECRUITMENT *
boxplot(mydata$botryllid~mydata$CO2.Treatment, cex.axis=0.8, boxwex=.5, varwidth=TRUE, xlab="Treatment", ylab="Percent cover of B. schlosseri")

zmuss<-lm(mydata$botryllid~mydata$Treatment)
plot(zmuss)
anova(zmuss)
summary(zmuss)
